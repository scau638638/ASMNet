...
from models.bo.BO_Net_dif_low_chan import BONet_dif_low
...
if __name__ == '__main__':
    ...
    for model_name in models_name_list:
        ...
        for dataset in args.dataset_list:
            model.load_state_dict(torch.load(r'exps/{}-{}/ckpt/{}_best_model.pth_1_4'.format(model_name, dataset, dataset)), strict=False)
            model.to(device)
            model.eval()
            ...
            for name in image_name_list:
                ...
                # binary
                gt_path = os.path.join(path_gt,  name[: -4]+ '_manual1'  + '.gif')
